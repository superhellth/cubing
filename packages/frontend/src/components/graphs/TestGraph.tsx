import { Box, useTheme, type SxProps, type Theme } from "@mui/system";
import type { AnimatedLineProps } from "@mui/x-charts";
import { AnimatedLine, ChartContainer, ChartsTooltip, ChartsXAxis, ChartsYAxis, LinePlot, MarkPlot, useChartId, useDrawingArea, useLineSeries, useXAxis, useXScale, useYScale } from "@mui/x-charts";
